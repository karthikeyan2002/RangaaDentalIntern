...
>>>>>>> 6c515854bf9a69c915e4e825087abbbdd178d47d:src/Dashboard.js
...
<div className="-my-2 py-2 overflow-x-hidden sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 patienttabel clear-both">
                ...
                <div className="align-middle inline-block min-w-full shadow overflow-hidden shadow-dashboard rounded-bl-lg rounded-br-lg">
                    <table className="min-w-full">
                        <thead className="text-white">
                            <tr>
                                <th className="pl-4 py-4 border-b-2 border-gray-300 text-left leading-4  tracking-wider uppercase">Full Name</th>
                                <th className="py-4 border-b-2 border-gray-300 text-center text-sm leading-4 tracking-wider uppercase">Age</th>
								<th className="py-4 border-b-2 border-gray-300 text-center text-sm leading-4 tracking-wider uppercase">Gender</th>
                                <th className="py-4 border-b-2 border-gray-300 text-center text-sm leading-4 tracking-wider uppercase">Phone</th>
                                {/* <th className="py-4 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider uppercase">Email</th> */}
								<th className="py-4 border-b-2 border-gray-300 text-center text-sm leading-4 tracking-wider uppercase">Complaint</th>
						...
						{patients.length > 0 ? (
							patients.map((patient) => (
								<tr>
									...
									<td className="py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5 text-center">
                                        <span className="relative inline-block px-3 py-1 font-semibold leading-1 text-center">
                                        <span aria-hidden className="absolute inset-0 bg-red-500 rounded-full"></span>
                                        <span className="relative text-xs text-white tacking-widest">Completed</span>
                                    </span>
									</td>
									<td className="py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5 text-center">
