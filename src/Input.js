...
function Input() {
    return (
        ...
        <table>
            ...
            <tr>
                 <td> <input name="Patient-Name" type="text" placeholder="Enter Patient's Name"/> </td>
                 <td> <input name="Patient-Age" type="number" placeholder="Enter Patient's Age"/> </td>
                 <td> <input name="Phone-number" type="number" placeholder="Patient's Phone number"/> </td>
                 <td>
                     <select>
