		...
		<div className='form2'>
			...
			>
				...
				<div className='overflow-auto md:overflow-scroll md:w-1/2 px-3 mb-6 md:mb-0'>
					<p className='font-black  text-center'>MEDICAL HISTORY</p>
						<table className="tablecenter sm:w-16">
							<thead className='border border-green-600 text-center'>
								<tr className='text-black'>
									<th className='px-2 py-2'>Name of the Disease</th>
									<th className='px-2 py-2'>Under Medication</th>
									<th className='px-2 py-2'>Not under Medication</th>
									<th className='px-2 py-2'>Unknown</th>
								</tr>
							</thead>
							<tbody className='text-center border'>
								...
								<tr>
									<td className='border px-2 py-2 text-left'>Bleeding disorder</td>
									<td className='border px-2 py-2'>
										<input
											type='radio'
											className='form-radio'
					...
					<div className='md:w-1/2 px-3 mb-6 md:mb-0'>
						...
						<table className='tablecenter border-collapse border border-green-800'>
							...
							<tbody className='text-center'>
								...
								<tr>
									<td className='w-1/2 px-2 py-2 text-left'>Tongue Thrusting</td>
									<td className='w-1/4 px-2 py-2'>
										<input
											type='radio'
											className='form-radio'
