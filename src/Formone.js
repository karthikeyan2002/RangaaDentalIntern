	...
	return (
		<div className='form'>
			<form
				...
				className='bg-yellow-300  shadow-md rounded p-10 mb-4 flex flex-col my-2'
			>
				<div className='-mx-4 md:flex mb-2'>
					...
					<div className='md:w-1/2 px-3 mb-6 md:mb-0'>
						...
						{formik.errors.lastName ? (
							<div className='text-white text-xs'>{formik.errors.lastName}</div>
						) : null}
					</div>
				</div>
				...
				<div className='-mx-4 md:flex mb-2'>
					<div className='md:w-1/3 px-3 mb-6 md:mb-0'>
						...
						/>
						{formik.errors.age ? (
							<div className='text-white text-xs'>{formik.errors.age}</div>
						) : null}
					</div>
					<div className='md:w-1/3 px-3 mb-6 md:mb-0'>
						<label
						...
						/>
						{formik.errors.phno ? (
							<div className='text-white text-xs'>{formik.errors.phno}</div>
						) : null}
					</div>
					...
					<div className='md:w-1/3 px-3 mb-6 md:mb-0'>
						...
						/>
						{formik.errors.email ? (
							<div className='text-white text-xs'>{formik.errors.email}</div>
						) : null}
					</div>
				</div>
